      ...
      <div class="bg-glass p-3 p-md-4 rounded-3 text-white">
        ...
        <form action="{{route('login.dologin')}}" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="email" class="form-control rounded-pill" id="exampleInputEmail1" aria-describedby="emailHelp" required>
          </div>
          <div class="mb-3">
          ...
          <div class="spacer-24"></div>
          <button type="submit" class="btn-custom-primary w-100 mb-3">Masuk</button>
          <div class="text-center">
            Belum memiliki akun? <a class="text-primary fw-bold text-decoration-none" href="{{route('register.index')}}">Buat Akun</a>
          </div>
        </form>
      </div>
