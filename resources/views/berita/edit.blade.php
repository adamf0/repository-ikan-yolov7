                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('berita.update')}}" method="post">
                                ...
                                <input type="hidden" name="scrapping" value="{{old('scrapping',$old->scrapping)}}">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <label>Url</label>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" name="url" placeholder="Masukkan url website..." value="{{old('url',$old->url)}}">
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <input type="text" class="form-control" name="kategori" placeholder="Masukkan kategori..." value="{{old('kategori',$old->kategori)}}">
                                        </div>
                                        <div class="col-12 form-group">
                                            <label>Judul</label>
                                            <input type="text" class="form-control" name="judul" placeholder="Masukkan judul..." value="{{old('judul',$old->judul)}}">
                                        </div>
                                        <div class="col-12 form-group">
                                            <label>Deskripsi</label>
                                            <textarea name="deskripsi" class="form-control" id="editor" rows="10" cols="40">{!! old('deskripsi',$old->deskripsi) !!}</textarea>
                                        </div>
                                    </div>
                                </div>
